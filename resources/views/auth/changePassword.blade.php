...
<head>
    ...
    <title>Change password | Portfolio</title>
    @laravelPWA
    ...
    <link rel="stylesheet" href="{{
                asset(
                    'backend/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css'
                )
            }}" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="{{ route('welcome') }}" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">Portfolio</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Want to change password ?</h4>


                        <form id="formAuthentication" method="POST" action="{{ route('submitPassword') }}">
                            @csrf
                            {{-- <div class="mb-3">
