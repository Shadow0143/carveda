...
@section('title')
<title>Master Category | Lists</title>
@endsection

@section('content')

<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master Category /</span> List</h4>

    <div class="card">
        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column mt-5">
            <a href="{{ route('categoryAdd') }}" class="btn btn-outline-primary btn-sm"> + ADD</a>
        </div>
                    ...
                    <tr class="@if($value->status ==1 )table-success @else table-danger @endif"
                        ...
                        <td>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <a href="{{ asset('category') }}/{{ $value->image }}" target="_blank">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        class="avatar avatar-xs pull-up" title="{{ $value->title }}">
                                        <img src="{{ asset('category') }}/{{ $value->image }}" alt="Avatar"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-warning"
                                        href="{{ route('categoryEdit', ['id' => $value->id]) }}"><i
...
<script>
    $('.delete').on('click',function(){
            ...
            swal({
                title: "Are you sure?",
                text: "want to remove this category.",
                type: "warning",
